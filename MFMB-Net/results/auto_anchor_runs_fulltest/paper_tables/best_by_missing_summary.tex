...
\centering
\small
\caption{Best method by missing rate on core metrics.}
\label{tab:best_by_missing}
\begin{tabular}{cllllp{6.5cm}}
\toprule
Missing & Best MAE & Best Corr & Best Non0 Acc-2 & Best Non0 F1 & Main Observation \\
\midrule
